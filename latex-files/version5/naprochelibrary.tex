...
\begin{proof}
    ...
    \begin{subproof}
        ...
        Thus $(a + b) \rmul (b - a) = \exp{b}{1+1} - \exp{a}{1+1}$ by \cref{real_add_comm,real_diff_squares}.
        Thus $\exp{b}{1+1} - \exp{a}{1+1} > 0$.
        Thus $\exp{a}{1+1} < \exp{b}{1+1}$ by \cref{real_one_in_naturals,real_pow_succ,real_pow_one,real_mul_closed,real_add_ident,real_lt_add,real_sub,real_add_assoc,real_add_inverse,real_add_comm,real_add_closed}.
    \end{subproof}
...
\begin{proof}
    ...
    Thus $\abs{a + b} \leq \abs{a} + \abs{b}$ by \cref{real_abs_in_reals,real_leq_abs,real_leq_add,real_add_closed,real_add_comm,real_leq_trans,real_abs_leq_if_pm_leq}.
\end{proof}
...
\begin{proof}
    ...
    $\abs{\abs{a} - \abs{b}} \leq \abs{a - b}$ by \cref{real_sub,real_add_assoc,real_add_inverse,real_add_comm,real_add_ident,real_add_closed,real_leq_add,real_abs_sub_swap,real_sub_swap_neg,real_abs_leq_if_pm_leq}.
\end{proof}
...
\begin{proof}
    ...
    \caseOf{$x < 0$.}
        ...
        Thus $t\in\reals$ by \cref{real_add_ident,real_naturals_subset_reals,subseteq}.
        Show that $t + 1\in\naturalsPlus$.
        \begin{subproof}
            \begin{byCase}
            \caseOf{$t = 0$.}
        ...
        \begin{byCase}
        \caseOf{$x = k + 1$.}
            Thus there exists $n\in\integers$ such that $n \leq x$ and $x < n + 1$ by \cref{real_add_inverse,real_add_comm,real_integers,real_add_ident,real_naturals_subset_reals,real_one_in_naturals,subseteq,real_zero_lt_one,real_lt_add}.
        \caseOf{$x \neq k + 1$.}
            Thus there exists $n\in\integers$ such that $n \leq x$ and $x < n + 1$ by \cref{real_add_inverse,real_leq_neg,real_neg_neg,real_naturals_subset_reals,real_one_in_naturals,subseteq,real_add_closed,real_lt_trichotomy}.
        \end{byCase}
    \end{byCase}
\end{proof}
...
\begin{proof}
    ...
    Thus $0 < \inv{N}$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_inv_pos}.
    ...
    Let $p = k / N$.
    Thus $p\in\reals$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_div,real_mul_closed}.
    Thus $a + 1 / N < b$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_mul_ident,real_div,real_mul_closed,real_sub,real_add_closed,real_lt_add,real_add_comm,real_add_assoc,real_add_inverse,real_add_ident}.
    Show that $p < b$.
    \begin{subproof}
        \begin{byCase}
        \caseOf{$k = 1$.}
            Thus $p < b$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_mul_ident,real_div,real_mul_closed,real_add_closed,real_lt_trichotomy,real_lt_add,real_add_ident,real_lt_trans}.
        \caseOf{$k \neq 1$.}
            ...
            \begin{byCase}
            \caseOf{$m / N = a$.}
                Thus $p < b$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_div,real_right_distrib,real_mul_ident}.
            \caseOf{$m / N \neq a$.}
                Thus $p < b$ by \cref{real_naturals_subset_reals,subseteq,real_mul_inverse,real_mul_ident,real_div,real_right_distrib,real_mul_closed,real_add_closed,real_lt_trichotomy,real_lt_add,real_lt_trans}.
            \end{byCase}
        \end{byCase}
    \end{subproof}
...
\begin{proof}
    ...
    \caseOf{$0 < b$.}
        \begin{byCase}
        \caseOf{$a < 0$.}
            Thus there exists $r\in\rationals$ such that $r\in\intervalopen{a}{b}$ by \cref{real_integers,real_one_in_naturals,real_mul_ident,singleton_iff,setminus_intro,real_add_ident,real_mul_inverse,real_div,real_mul_zero,real_rationals,intervalopen}.
        \caseOf{$0 \leq a$.}
            Thus there exists $r\in\rationals$ such that $r\in\intervalopen{a}{b}$ by \cref{real_rationals_nonneg_interval,real_integers,real_naturals_subset_reals,subseteq,real_mul_ident,real_zero_lt_one,real_one_leq_naturalsplus,real_lt_trans,real_pos_nonzero,singleton_iff,setminus_intro,real_rationals}.
        \end{byCase}
    \caseOf{$b \leq 0$.}
        ...
        Let $p = \neg{(n / N)}$.
        Thus $p\in\rationals$ by \cref{real_integers,real_naturals_subset_reals,subseteq,real_add_inverse,real_add_comm,real_zero_lt_one,real_one_leq_naturalsplus,real_lt_trans,real_pos_nonzero,singleton_iff,setminus_intro,real_div,real_mul_inverse,real_mul_closed,real_mul_comm,real_mul_neg_right,real_rationals}.
        Thus there exists $r\in\rationals$ such that $r\in\intervalopen{a}{b}$ by \cref{real_add_inverse,intervalopen,real_neg_neg,real_lt_neg}.
    \end{byCase}
\end{proof}
